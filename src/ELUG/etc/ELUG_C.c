/* ELUG.F -- translated by f2c (version 20010618).
...
/* *********************************************************************** */
	...
	ret_val = instcomm_1.elvmax[*instr - 1] - (*rline - (float)2.5) * 
		instcomm_1.elvln[*instr - 1];
/***
        printf("instcomm_1.elvmax[*instr - 1]= %f rline= %f
	...
	ewinc2;
{
  ...
  /***
  printf("nscyc1= %d, *nsinc1= %d , *ewcyc1= %d , *ewinc1= %d , *nscyc2= %d , *nsinc2= %d , *ewcyc2= %d , *ewinc2= %d\n\n",
	 *nscyc1, *nsinc1, *ewcyc1, *ewinc1, *nscyc2, *nsinc2, *ewcyc2, *ewinc2);
  ***/   

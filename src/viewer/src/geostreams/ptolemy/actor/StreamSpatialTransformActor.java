...
/**
 * Stream spatial transform with optional restriction operator.
 *
 * TODO Implement me!  For now, it';s just a copy of RegionOfInterest.
 * 
 * @author Carlos Rueda-Velasquez
 * @version $Id: StreamSpatialTransformActor.java,v 1.1 2007/09/16 09:47:03 crueda Exp $
 */
public class StreamSpatialTransformActor extends StreamUnaryOperatorActor {
	...
	/** {@inheritDoc} */
	public StreamSpatialTransformActor(CompositeEntity container, String name)
			throws NameDuplicationException, IllegalActionException {
		super(container, name, "ST");
		_createRoiParameter();

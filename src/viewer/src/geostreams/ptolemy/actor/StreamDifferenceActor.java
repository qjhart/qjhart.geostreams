 ...
 * @version $Id: StreamDifferenceActor.java,v 1.3 2007/06/06 19:34:19 crueda Exp $
 */
public class StreamDifferenceActor extends StreamBinaryOperatorActor {
...
//	TODO: factor out common functionality into StreamBinaryOperatorActor
	...
	/** {@inheritDoc} */
	public StreamDifferenceActor(CompositeEntity container, String name)
	throws NameDuplicationException, IllegalActionException {
		super(container, name, "\u2212");   // minus
	}

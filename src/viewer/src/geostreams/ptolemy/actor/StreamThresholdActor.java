 ...
 * @version $Id: StreamThresholdActor.java,v 1.2 2007/06/06 09:06:29 crueda Exp $
 */
public class StreamThresholdActor extends StreamUnaryOperatorActor {
	 ...
	 */
	public StreamThresholdActor(CompositeEntity container, String name)

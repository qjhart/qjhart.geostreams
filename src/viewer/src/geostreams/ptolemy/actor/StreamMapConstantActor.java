 ...
 * @version $Id: StreamMapConstantActor.java,v 1.1 2007/06/04 09:07:52 crueda Exp $
 */
public class StreamMapConstantActor extends StreamUnaryOperatorActor {
	...
	public StreamMapConstantActor(CompositeEntity container, String name)

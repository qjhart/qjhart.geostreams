...
void ImageAtT<pointType, TIMESTAMP, valueType>::print () {
  std::cout << "Imageid=" << this->imageId << std::endl ;

  // pointSet->print () ;

  std::cout << "low x=" << getLowX () << std::endl ;
  std::cout << "high x=" << getHighX () << std::endl ;
  std::cout << "low y=" << getLowY () << std::endl ;
  std::cout << "high y=" << getHighY () << std::endl ;

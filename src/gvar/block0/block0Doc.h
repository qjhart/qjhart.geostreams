...
public: 
  ...
  // double lon0(); // Frame top latitude
  // double lon1(); // Frame bot latitude
  // double lat0(); // Frame left longitude
  // double lat1(); // Frame right longitude
...
inline int Block0Doc::frame() { return Ifram; }
// inline double Block0Doc::lat0() { return (double)Ifnw1; }
// inline double Block0Doc::lat1() { return (double)Ifse1; }
// inline double Block0Doc::lon0() { return (double)Ifnw2; }
// inline double Block0Doc::lon1() { return (double)Ifse2; }
